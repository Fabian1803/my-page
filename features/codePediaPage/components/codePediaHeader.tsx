    ...
    <header className="h-17 px-4 lg:pl-9 lg:pr-12">
      ...
      grid md:grid-cols-[50_220_auto_260]">
        ...
        <div className="h-full items-center hidden lg:flex">
          <div className="items-center border-1 grid grid-cols-[30_auto_80] w-full max-w-120">
            <div className="flex justify-center"><IoIosSearch className="text-gray-500" size={20} /></div>
            <input id="cp-search" type="text" placeholder="Buscar en Codepedia" className="outline-none" />
            <button className="px-3 py-1 bg-gray-100 hover:bg-gray-300 font-bold text-sm border-l-1">Buscar</button>
          </div>
        </div>
        ...
        <div className="md:flex items-center justify-end hidden">
          <ul className="flex gap-2 text-sm text-blue-800">
            <li>Donaciones</li>
