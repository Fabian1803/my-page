...
interface ProjectsHeaderBarProps {
    isLoading: boolean;
...
export default function ProjectsHeaderBar({
    isLoading,
    filterTab,
    onToggleFilterTab,
    onRefresh
}: ProjectsHeaderBarProps) {
    return (
        <div className="flex justify-between border-b border-[#dbdce0] px-4 sm:px-6 pt-3 pb-2 bg-white rounded-t-2xl">
            <div className="flex gap-2 sm:gap-3 justify-between w-full sm:w-auto items-center">
                <h1 className="text-base sm:text-lg font-medium text-gray-800 truncate">Mis Proyectos</h1>
